...
function highlight() {
    let status = document.querySelectorAll("tr > td:last-child");
    let gender = document.querySelectorAll("tr > td:nth-child(3)");
    let age = document.querySelectorAll("tr > td:nth-child(2)");
    ...
    if (item.dataset.available == undefined) {
    item.parentElement.dataset.available = "hidden";
    }
    }
...
>>>>>>> a6aa10ddc8cf99623f876e391baa5119d8aee5bf
